...
`cipher query <symbol> --json` works from inside a project. The existing
`cipher query <directory> <symbol>` form is unchanged.
...
`cipher health` reported **100/100 Grade A** for directories it parsed nothing from —
...
Cipher now refuses to score when there is no data: it names the directory, lists the
...
Cipher was under-reporting its own dependency graph. Four parser bugs, all found by
running Cipher against itself:
...
### Added
- **`cipher diff` CLI command** — Structural comparison between two git commits
...
### Added
- **Dependency Health Score** — `cipher health` command scores architecture 0-100 across 6 dimensions
...
- Health history tracking in `.cipher/health-history.json` (last 50 checks)
...
### Changed
- Updated `cipher docs` command to support all 11 document types
...
### Fixed  
- Windows installation failure: `npm install -g cipher-cli` now works without Python or Visual Studio Build Tools
...
### Added
- **`cipher docs` command** — Auto-generate comprehensive codebase documentation from dependency graphs
...
- `.cipher/metadata.json` for tracking document freshness and generation stats
...
### Fixed
- **npm bin field**: Corrected bin path format from `./dist/index.js` to `dist/index.js` to resolve npm publish warning "bin[cipher] script name was invalid and removed." Global CLI install (`npm install -g cipher-cli`) now works correctly for all users.
...
### Added
- **Public launch** — First public release of Cipher
- **npm package** published as `cipher-cli` on npmjs.com
- **GitHub repository** at github.com/cipher/cipher (public)
- **Official MCP Registry** listing: `io.github.cipher/cipher`
- **Glama** listing: approved and claimed
- **mcpservers.org** listing: submitted
- **Landing page** at cipher.dev (Cloudflare Pages)
- **CLA enforcement** via GitHub Action
- **About section**: YouTube, book, LinkedIn links in README
...
### Changed
- **Rename**: CodeGraph → Cipher across entire codebase
- **License**: BSL 1.1 (converts to Apache 2.0 on Feb 25, 2029)
...
- [GitHub Repository](https://github.com/cipher/cipher)
- [npm Package](https://www.npmjs.com/package/cipher-cli)
- [Website](https://cipher.dev)
- [MCP Registry](https://registry.modelcontextprotocol.io)

[1.7.1]: https://github.com/cipher/cipher/compare/v1.7.0...v1.7.1
[0.2.6]: https://github.com/cipher/cipher/compare/v0.2.5...v0.2.6
[0.2.5]: https://github.com/cipher/cipher/compare/v0.2.0...v0.2.5
[0.2.0]: https://github.com/cipher/cipher/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/cipher/cipher/releases/tag/v0.1.0

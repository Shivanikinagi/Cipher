...
/**
 * Auto-generate .cipher/AGENTS.md after parse.
 *
 ...
 * recommended Cipher MCP tool workflow.
 */
...
/**
 * Write AGENTS.md to .cipher/ directory.
...
export function writeAgentsMd(
  ...
  const cipherDir = join(projectRoot, '.cipher');
  const agentsPath = join(cipherDir, 'AGENTS.md');

...
Thank you for your interest in contributing to Cipher! This document provides guidelines and instructions for contributing to the project.
...
The CLA ensures that the project maintainers can retain licensing flexibility while protecting contributor rights. Your contributions remain attributed to you.
...
- **No writes to user project directories** — Cipher is read-only
...
6. **Push** to your fork
7. **Open PR** against `cipher/cipher:main`
...
4. **Environment** (OS, Node.js version, Cipher version)
...
- **Email:** hello@cipher.dev
- **GitHub Issues:** [github.com/cipher/cipher/issues](https://github.com/cipher/cipher/issues)

Thank you for helping make Cipher better!

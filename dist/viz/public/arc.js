...
// ── Legacy global state and functions (used by cipher viz) ──
let graphData = null;
let svg = null;
let g = null;
...
function exportToSVG() {
  ...
  link.href = url;
  link.download = `cipher-${graphData.projectName}.svg`;
  link.click();
...
function exportToPNG() {
  ...
  img.onload = () => {
    ...
    canvas.toBlob((blob) => {
      ...
      const link = document.createElement('a');
      link.href = pngUrl;
      link.download = `cipher-${graphData.projectName}.png`;
      link.click();

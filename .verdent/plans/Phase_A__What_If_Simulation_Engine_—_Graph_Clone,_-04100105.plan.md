...
```bash
cd /Users/cipher/Developer/code-graph
npm run build
...
Verify: clean output, no TypeScript errors, no writes to `.cipher/health-history.json`.
...
| 3 | `src/index.ts` | `cipher whatif --help` shows all options |
